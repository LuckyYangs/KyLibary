package com.ls.libarys.lsrefreshlayout.layout;
...
import com.ls.libarys.lsrefreshlayout.layout.api.DefaultRefreshFooterCreator;
import com.ls.libarys.lsrefreshlayout.layout.api.DefaultRefreshHeaderCreator;
import com.ls.libarys.lsrefreshlayout.layout.api.RefreshContent;
import com.ls.libarys.lsrefreshlayout.layout.api.RefreshFooter;
import com.ls.libarys.lsrefreshlayout.layout.api.RefreshHeader;
import com.ls.libarys.lsrefreshlayout.layout.api.RefreshInternal;
import com.ls.libarys.lsrefreshlayout.layout.api.RefreshKernel;
import com.ls.libarys.lsrefreshlayout.layout.api.RefreshLayout;
import com.ls.libarys.lsrefreshlayout.layout.api.ScrollBoundaryDecider;
import com.ls.libarys.lsrefreshlayout.layout.constant.DimensionStatus;
import com.ls.libarys.lsrefreshlayout.layout.constant.RefreshState;
import com.ls.libarys.lsrefreshlayout.layout.constant.SpinnerStyle;
import com.ls.libarys.lsrefreshlayout.layout.footer.BallPulseFooter;
import com.ls.libarys.lsrefreshlayout.layout.header.BezierRadarHeader;
import com.ls.libarys.lsrefreshlayout.layout.impl.RefreshContentWrapper;
import com.ls.libarys.lsrefreshlayout.layout.impl.RefreshFooterWrapper;
import com.ls.libarys.lsrefreshlayout.layout.impl.RefreshHeaderWrapper;
import com.ls.libarys.lsrefreshlayout.layout.listener.OnLoadMoreListener;
import com.ls.libarys.lsrefreshlayout.layout.listener.OnMultiPurposeListener;
import com.ls.libarys.lsrefreshlayout.layout.listener.OnRefreshListener;
import com.ls.libarys.lsrefreshlayout.layout.listener.OnRefreshLoadMoreListener;
import com.ls.libarys.lsrefreshlayout.layout.listener.OnStateChangedListener;
import com.ls.libarys.lsrefreshlayout.layout.util.DelayedRunnable;
import com.ls.libarys.lsrefreshlayout.layout.util.DensityUtil;
import com.ls.libarys.lsrefreshlayout.layout.util.ScrollBoundaryUtil;
import com.ls.libarys.lsrefreshlayout.layout.util.ViscousFluidInterpolator;
...
import static com.ls.libarys.lsrefreshlayout.layout.util.DensityUtil.dp2px;
import static com.ls.libarys.lsrefreshlayout.layout.util.SmartUtil.fling;
import static com.ls.libarys.lsrefreshlayout.layout.util.SmartUtil.getColor;
import static com.ls.libarys.lsrefreshlayout.layout.util.SmartUtil.isScrollableView;
...
public class LsRefreshLayout extends ViewGroup implements RefreshLayout, NestedScrollingParent, NestedScrollingChild {
...
//    protected int mFooterExtendHeight;  //扩展高度
    ...
    public LsRefreshLayout(Context context) {
        this(context, null);
    }

    public LsRefreshLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LsRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.LsRefreshLayout);

        setNestedScrollingEnabled(ta.getBoolean(R.styleable.LsRefreshLayout_srlEnableNestedScrolling, false));
        mDragRate = ta.getFloat(R.styleable.LsRefreshLayout_srlDragRate, mDragRate);
        mHeaderMaxDragRate = ta.getFloat(R.styleable.LsRefreshLayout_srlHeaderMaxDragRate, mHeaderMaxDragRate);
        mFooterMaxDragRate = ta.getFloat(R.styleable.LsRefreshLayout_srlFooterMaxDragRate, mFooterMaxDragRate);
        mHeaderTriggerRate = ta.getFloat(R.styleable.LsRefreshLayout_srlHeaderTriggerRate, mHeaderTriggerRate);
        mFooterTriggerRate = ta.getFloat(R.styleable.LsRefreshLayout_srlFooterTriggerRate, mFooterTriggerRate);
        mEnableRefresh = ta.getBoolean(R.styleable.LsRefreshLayout_srlEnableRefresh, mEnableRefresh);
        mReboundDuration = ta.getInt(R.styleable.LsRefreshLayout_srlReboundDuration, mReboundDuration);
        mEnableLoadMore = ta.getBoolean(R.styleable.LsRefreshLayout_srlEnableLoadMore, mEnableLoadMore);
        mHeaderHeight = ta.getDimensionPixelOffset(R.styleable.LsRefreshLayout_srlHeaderHeight, density.dip2px(100));
        mFooterHeight = ta.getDimensionPixelOffset(R.styleable.LsRefreshLayout_srlFooterHeight, density.dip2px(60));
        mHeaderInsetStart = ta.getDimensionPixelOffset(R.styleable.LsRefreshLayout_srlHeaderInsetStart, 0);
        mFooterInsetStart = ta.getDimensionPixelOffset(R.styleable.LsRefreshLayout_srlFooterInsetStart, 0);
        mDisableContentWhenRefresh = ta.getBoolean(R.styleable.LsRefreshLayout_srlDisableContentWhenRefresh, mDisableContentWhenRefresh);
        mDisableContentWhenLoading = ta.getBoolean(R.styleable.LsRefreshLayout_srlDisableContentWhenLoading, mDisableContentWhenLoading);
        mEnableHeaderTranslationContent = ta.getBoolean(R.styleable.LsRefreshLayout_srlEnableHeaderTranslationContent, mEnableHeaderTranslationContent);
        mEnableFooterTranslationContent = ta.getBoolean(R.styleable.LsRefreshLayout_srlEnableFooterTranslationContent, mEnableFooterTranslationContent);
        mEnablePreviewInEditMode = ta.getBoolean(R.styleable.LsRefreshLayout_srlEnablePreviewInEditMode, mEnablePreviewInEditMode);
        mEnableAutoLoadMore = ta.getBoolean(R.styleable.LsRefreshLayout_srlEnableAutoLoadMore, mEnableAutoLoadMore);
        mEnableOverScrollBounce = ta.getBoolean(R.styleable.LsRefreshLayout_srlEnableOverScrollBounce, mEnableOverScrollBounce);
        mEnablePureScrollMode = ta.getBoolean(R.styleable.LsRefreshLayout_srlEnablePureScrollMode, mEnablePureScrollMode);
        mEnableScrollContentWhenLoaded = ta.getBoolean(R.styleable.LsRefreshLayout_srlEnableScrollContentWhenLoaded, mEnableScrollContentWhenLoaded);
        mEnableScrollContentWhenRefreshed = ta.getBoolean(R.styleable.LsRefreshLayout_srlEnableScrollContentWhenRefreshed, mEnableScrollContentWhenRefreshed);
        mEnableLoadMoreWhenContentNotFull = ta.getBoolean(R.styleable.LsRefreshLayout_srlEnableLoadMoreWhenContentNotFull, mEnableLoadMoreWhenContentNotFull);
        mEnableFooterFollowWhenLoadFinished = ta.getBoolean(R.styleable.LsRefreshLayout_srlEnableFooterFollowWhenLoadFinished, mEnableFooterFollowWhenLoadFinished);
        mEnableClipHeaderWhenFixedBehind = ta.getBoolean(R.styleable.LsRefreshLayout_srlEnableClipHeaderWhenFixedBehind, mEnableClipHeaderWhenFixedBehind);
        mEnableClipFooterWhenFixedBehind = ta.getBoolean(R.styleable.LsRefreshLayout_srlEnableClipFooterWhenFixedBehind, mEnableClipFooterWhenFixedBehind);
        mEnableOverScrollDrag = ta.getBoolean(R.styleable.LsRefreshLayout_srlEnableOverScrollDrag, mEnableOverScrollDrag);
        mFixedHeaderViewId = ta.getResourceId(R.styleable.LsRefreshLayout_srlFixedHeaderViewId, View.NO_ID);
        mFixedFooterViewId = ta.getResourceId(R.styleable.LsRefreshLayout_srlFixedFooterViewId, View.NO_ID);

        if (mEnablePureScrollMode && !ta.hasValue(R.styleable.LsRefreshLayout_srlEnableOverScrollDrag)) {
            mEnableOverScrollDrag = true;
        }

        mManualLoadMore = ta.hasValue(R.styleable.LsRefreshLayout_srlEnableLoadMore);
        mManualNestedScrolling = ta.hasValue(R.styleable.LsRefreshLayout_srlEnableNestedScrolling);
        mManualHeaderTranslationContent = ta.hasValue(R.styleable.LsRefreshLayout_srlEnableHeaderTranslationContent);
        mHeaderHeightStatus = ta.hasValue(R.styleable.LsRefreshLayout_srlHeaderHeight) ? DimensionStatus.XmlLayoutUnNotify : mHeaderHeightStatus;
        mFooterHeightStatus = ta.hasValue(R.styleable.LsRefreshLayout_srlFooterHeight) ? DimensionStatus.XmlLayoutUnNotify : mFooterHeightStatus;
...
//        mFooterExtendHeight = (int) Math.max((mFooterHeight * (mFooterMaxDragRate - 1)), 0);
        ...
        int accentColor = ta.getColor(R.styleable.LsRefreshLayout_srlAccentColor, 0);
        int primaryColor = ta.getColor(R.styleable.LsRefreshLayout_srlPrimaryColor, 0);
        if (primaryColor != 0) {
            if (accentColor != 0) {
        ...
        if (!thisView.isInEditMode()) {
            ...
            if (!mManualNestedScrolling && !isNestedScrollingEnabled()) {
                post(new Runnable() {
                    @Override
                    public void run() {
                        final View thisView = LsRefreshLayout.this;
                        for (ViewParent parent = thisView.getParent() ; parent != null ; ) {
                            if (parent instanceof NestedScrollingParent) {
                                View target = LsRefreshLayout.this;
        ...
        AnimatorListenerAdapter listener = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mRefreshListener != null) {
                    mRefreshListener.onRefresh(LsRefreshLayout.this);
                } else if (mOnMultiPurposeListener == null) {
                    finishRefresh(3000);
                }
                if (mRefreshHeader != null) {
                    mRefreshHeader.onStartAnimator(LsRefreshLayout.this, mHeaderHeight,  (int) (mHeaderMaxDragRate * mHeaderHeight));
                }
                if (mOnMultiPurposeListener != null && mRefreshHeader instanceof RefreshHeader) {
                    mOnMultiPurposeListener.onRefresh(LsRefreshLayout.this);
...
//    }
    ...
    @Override
    public LsRefreshLayout setFooterHeight(float heightDp) {
...
//    }
    ...
    @Override
    public LsRefreshLayout setHeaderHeight(float heightDp) {
...
//    }
    ...
    @Override
    public LsRefreshLayout setHeaderInsetStart(float insetDp) {
...
//    }
    ...
    @Override
    public LsRefreshLayout setFooterInsetStart(float insetDp) {
...
//    }
     ...
     */
    @Override
    public LsRefreshLayout setDragRate(float rate) {
        this.mDragRate = rate;
        return this;
    }
     ...
     */
    @Override
    public LsRefreshLayout setHeaderMaxDragRate(float rate) {
...
//        this.mHeaderExtendHeight = (int) Math.max((mHeaderHeight * (mHeaderMaxDragRate - 1)), 0);
     ...
     */
    @Override
    public LsRefreshLayout setFooterMaxDragRate(float rate) {
...
//        this.mFooterExtendHeight = (int) Math.max((mFooterHeight * (mFooterMaxDragRate - 1)), 0);
     ...
     */
    @Override
    public LsRefreshLayout setHeaderTriggerRate(float rate) {
     ...
     */
    @Override
    public LsRefreshLayout setFooterTriggerRate(float rate) {
     ...
     */
    @Override
    public LsRefreshLayout setReboundInterpolator(@NonNull Interpolator interpolator) {
     ...
     */
    @Override
    public LsRefreshLayout setReboundDuration(int duration) {
     ...
     */
    @Override
    public LsRefreshLayout setEnableLoadMore(boolean enabled) {
     ...
     */
    @Override
    public LsRefreshLayout setEnableRefresh(boolean enabled) {
     ...
     */
    @Override
    public LsRefreshLayout setEnableHeaderTranslationContent(boolean enabled) {
     ...
     */
    @Override
    public LsRefreshLayout setEnableFooterTranslationContent(boolean enabled) {
     ...
     */
    @Override
    public LsRefreshLayout setEnableAutoLoadMore(boolean enabled) {
     ...
     */
    @Override
    public LsRefreshLayout setEnableOverScrollBounce(boolean enabled) {
     ...
     */
    @Override
    public LsRefreshLayout setEnablePureScrollMode(boolean enabled) {
     ...
     */
    @Override
    public LsRefreshLayout setEnableScrollContentWhenLoaded(boolean enabled) {
     ...
     */
    @Override
    public LsRefreshLayout setEnableScrollContentWhenRefreshed(boolean enabled) {
     ...
     */
    @Override
    public LsRefreshLayout setEnableLoadMoreWhenContentNotFull(boolean enabled) {
     ...
     */
    @Override
    public LsRefreshLayout setEnableOverScrollDrag(boolean enabled) {
     ...
     */
    @Override
    public LsRefreshLayout setEnableFooterFollowWhenLoadFinished(boolean enabled) {
     ...
     */
    @Override
    public LsRefreshLayout setEnableClipHeaderWhenFixedBehind(boolean enabled) {
     ...
     */
    @Override
    public LsRefreshLayout setEnableClipFooterWhenFixedBehind(boolean enabled) {
     ...
     */
    @Override
    public LsRefreshLayout setDisableContentWhenRefresh(boolean disable) {
     ...
     */
    @Override
    public LsRefreshLayout setDisableContentWhenLoading(boolean disable) {
     ...
     */
    @Override
    public LsRefreshLayout setRefreshHeader(@NonNull RefreshHeader header) {
     ...
     */
    @Override
    public LsRefreshLayout setRefreshHeader(@NonNull RefreshHeader header, int width, int height) {
        if (mRefreshHeader != null) {
     ...
     */
    @Override
    public LsRefreshLayout setRefreshFooter(@NonNull RefreshFooter footer) {
     ...
     */
    @Override
    public LsRefreshLayout setRefreshFooter(@NonNull RefreshFooter footer, int width, int height) {
        if (mRefreshFooter != null) {
     ...
     */
    @Override
    public LsRefreshLayout getLayout() {
        return this;
    }
     ...
     */
    @Override
    public LsRefreshLayout setOnRefreshListener(OnRefreshListener listener) {
     ...
     */
    @Override
    public LsRefreshLayout setOnLoadMoreListener(OnLoadMoreListener listener) {
     ...
     */
    @Override
    public LsRefreshLayout setOnRefreshLoadMoreListener(OnRefreshLoadMoreListener listener) {
        this.mRefreshListener = listener;
        this.mLoadMoreListener = listener;
        this.mEnableLoadMore = mEnableLoadMore || (!mManualLoadMore && listener != null);
        return this;
    ...
    /**
     * 设置多功能监听器
     * @param listener 建议使用 {@link com.ls.libarys.lsrefreshlayout.layout.listener.SimpleMultiPurposeListener}
     * @return SmartRefreshLayout
     */
    @Override
    public LsRefreshLayout setOnMultiPurposeListener(OnMultiPurposeListener listener) {
     ...
     */
    @Override
    public LsRefreshLayout setPrimaryColors(@ColorInt int... primaryColors) {
        if (mRefreshHeader != null) {
     ...
     */
    @Override
    public LsRefreshLayout setPrimaryColorsId(@ColorRes int... primaryColorId) {
        final View thisView = this;
    ...
    /**
     * 设置滚动边界
     * @param boundary 建议使用 {@link com.ls.libarys.lsrefreshlayout.layout.impl.ScrollBoundaryDeciderAdapter}
     * @return SmartRefreshLayout
     */
    @Override
    public LsRefreshLayout setScrollBoundaryDecider(ScrollBoundaryDecider boundary) {
     ...
     */
    @Override
    public LsRefreshLayout setNoMoreData(boolean noMoreData) {
     ...
     */
    @Override
    public LsRefreshLayout finishRefresh() {
     ...
     */
    @Override
    public LsRefreshLayout finishLoadMore() {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
     ...
     */
    @Override
    public LsRefreshLayout finishRefresh(int delayed) {
     ...
     */
    @Override
    public LsRefreshLayout finishRefresh(boolean success) {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
     ...
     */
    @Override
    public LsRefreshLayout finishRefresh(int delayed, final boolean success) {
        postDelayed(new Runnable() {
            ...
            public void run() {
                if (mState == RefreshState.Refreshing && mRefreshHeader != null && mRefreshContent != null) {
                    ...
                    int startDelay = mRefreshHeader.onFinish(LsRefreshLayout.this, success);
                    if (mOnMultiPurposeListener != null && mRefreshHeader instanceof RefreshHeader) {
                    ...
                    if (startDelay < Integer.MAX_VALUE) {
                        if (mIsBeingDragged) {
                            ...
                            LsRefreshLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_DOWN, mLastTouchX, mTouchY + mSpinner - mTouchSlop*2, 0));
                            LsRefreshLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_MOVE, mLastTouchX, mTouchY + mSpinner, 0));
                        }
                        if (mSpinner > 0) {
     ...
     */
    @Override
    public LsRefreshLayout finishLoadMore(int delayed) {
     ...
     */
    @Override
    public LsRefreshLayout finishLoadMore(boolean success) {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
     ...
     */
    @Override
    public LsRefreshLayout finishLoadMore(int delayed, final boolean success, final boolean noMoreData) {
        postDelayed(new Runnable() {
            @Override
            public void run() {
                if (mState == RefreshState.Loading && mRefreshFooter != null && mRefreshContent != null) {
                    notifyStateChanged(RefreshState.LoadFinish);
                    final int startDelay = mRefreshFooter.onFinish(LsRefreshLayout.this, success);
                    if (mOnMultiPurposeListener != null && mRefreshFooter instanceof RefreshFooter) {
                    ...
                    if (startDelay < Integer.MAX_VALUE) {
                        ...
                        if (mIsBeingDragged) {
                            ...
                            LsRefreshLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_DOWN, mLastTouchX, mTouchY + offset + mTouchSlop * 2, 0));
                            LsRefreshLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_MOVE, mLastTouchX, mTouchY + offset, 0));
                        } else if (mTotalUnconsumed != 0) {
                            mDragDirection = 'h';
                            mTotalUnconsumed = 0;
                            final long time = System.currentTimeMillis();
                            LsRefreshLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_CANCEL, mLastTouchX, mTouchY + offset, 0));
...
//                            SmartRefreshLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_MOVE, mLastTouchX, mTouchY + offset, 0));
     ...
     */
    @Override
    public LsRefreshLayout finishLoadMoreWithNoMoreData() {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
...
//                    }
        ...
        public ValueAnimator animSpinner(int endSpinner) {
            return LsRefreshLayout.this.animSpinner(endSpinner, 0, mReboundInterpolator, mReboundDuration);
        }
